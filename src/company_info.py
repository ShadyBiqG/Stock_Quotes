...
✓ ВСЕ поля: name, description, sector, industry - ТОЛЬКО ПО-РУССКИ
✓ Переводи названия компаний на русский (AMD → АМД)
✓ Описание должно быть информативным (2-3 предложения)
✓ Используй русскую терминологию
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ФОРМАТ ОТВЕТА (только JSON, БЕЗ markdown):
{{
    "name": "Полное название компании на русском",
