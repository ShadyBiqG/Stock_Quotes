...
class CompanyInfoProvider:
    ...
    def _get_from_llm(self, ticker: str) -> Dict:
        ...
        try:
            prompt = f"""
Ты - русскоязычный финансовый аналитик. Предоставь информацию о компании с тикером {ticker}.

⚠️ СТРОГО ОБЯЗАТЕЛЬНО:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✓ Название компании (name) - ОСТАВЬ В ОРИГИНАЛЕ (на английском)
✓ Описание (description) - ТОЛЬКО НА РУССКОМ ЯЗЫКЕ
✓ Сектор (sector) и отрасль (industry) - ТОЛЬКО НА РУССКОМ
✓ Описание должно быть информативным (2-3 предложения)
✓ Используй русскую терминологию в описании
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ФОРМАТ ОТВЕТА (только JSON, БЕЗ markdown):
{{
    "name": "Полное название компании НА АНГЛИЙСКОМ (оригинальное)",
    "description": "Подробное описание деятельности НА РУССКОМ (2-3 предложения)",
    "sector": "Сектор на русском",
    "industry": "Отрасль на русском"
}}
...
{{
    ...
    "description": "Американская полупроводниковая компания, разрабатывающая процессоры для компьютеров и серверов. Является вторым по величине производителем процессоров после Intel.",
...
{{
    "name": "Apple Inc.",
    "description": "Американская технологическая компания, производитель электроники, программного обеспечения и онлайн-сервисов. Известна продуктами iPhone, iPad, Mac.",
    "sector": "Информационные технологии", 
    "industry": "Потребительская электроника"
}}

Если компания неизвестна: все поля = "Неизвестно"

ВАЖНО: Отвечай ТОЛЬКО JSON, без ```json и без комментариев!
"""
